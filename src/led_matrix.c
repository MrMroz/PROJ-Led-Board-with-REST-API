...
int pixel = 0; //jeśli wykryjemy pizel to pixel = 1
...
// Funkcja do wysyłania bufora ramki do matrycy LED __ raczej nieużywana
void send_frame() {   
...
while (true) {
	...
	// fill_matrix(1,1,1,300);
	// fill_half_matrix(1,0,0,300);
	
	// animation(30, 200);
	picture_animation(0, 0, 1, 50);
